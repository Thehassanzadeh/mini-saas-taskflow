...
class CreateUserInput(BaseModel):
    ...
    email: EmailStr = Field(title= "Email", description="input your email, must be valid")
 
    phone_number: str = Field(title= "Phone Number", description="input your phone number")
